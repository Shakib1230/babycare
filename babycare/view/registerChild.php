...
<head>
    <body style="background-image: url(../assets/image/im.jpg); background-repeat: no-repeat; background-size: cover;">
...
<form method="POST" action="registerChild.php">
				...
				<input type="text" class="form-control" placeholder="Father Name" name="child_father_name"> 
				<input type="text" class="form-control" placeholder="Mother Name" name="child_mother_name">
