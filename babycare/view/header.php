            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li class=""><a href="index.php">Home</a></li>
                <li><a href="registerAdmin.php">Admin registration</a></li>
                <li><a href="registerChild.php">User registration</a></li>
                <li><a href="report.php">Report</a></li>
                <li><a href="child_list.php">Children list</a></li>
...
<!-- Header Starts -->
<!-- <div class="header">
<a href="#" style="text-align: left;"><img src="images/logo1.png" alt="babycare"></a>
